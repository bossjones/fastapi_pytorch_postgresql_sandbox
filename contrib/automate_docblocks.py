                        ...
                        if docstring:
                            ...
                            if args:
                                ...
                                argument_lines = [
                                    ...
                                    if not any(x in arg for x in exclude)
                                ]
                                    ...
                                    if arg_name in argument:
                                        ...
                                        if argument.split(":"):
                                            if "(" and ")" in argument.split(":")[0]:
                                                ...
                                                idx = docstring_lines.index(
                                                    f"{argument}",
                                                )
                                                new_arguments[
                                                    idx
                                                ] = f"{new_argument_docstring}"

                                            else:
                                                print(
                                                    f"no variable type in the argument: {arg_name}",
                                                )
                                        else:
                                            print(
                                                f"no 'arg : description'-format for this argument: {arg_name}",
                                            )
                                    else:
                                        print(
                                            f"no docstring for this argument: {arg_name}",
                                        )
                            else:
                                print(
                                    f"there are no arguments in this docstring: {function}",
                                )
                                ...
                                if raw_return:
                                    ...
                                    if return_lines and len(return_lines) == 1:
                                        ...
                                        if return_arg.split(":"):
                                            ...
                                            new_arguments[
                                                idx
                                            ] = f"{new_return_docstring}\n"

                                        else:
                                            print(
                                                f"no variable-type in return statement docstring: {function}",
                                            )
                                    else:
                                        print(
                                            f"no return statement docstring argument: {function}",
                                        )
                                else:
                                    print(
                                        f"no return argument in docstring for function: {function}",
                                    )
                            else:
                            ...
                            docstring_lines = [
                                f"{' ' * docstring_node.col_offset}{line}"
