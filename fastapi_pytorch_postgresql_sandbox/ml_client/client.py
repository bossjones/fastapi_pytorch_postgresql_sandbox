...
class ApifyClient(_BaseApifyClient):
    ...
    # def request_queue(
    #     self, request_queue_id: str, *, client_key: Optional[str] = None
    # ) -> RequestQueueClient:
    ...
    #         resource_id=request_queue_id, client_key=client_key, **self._options()
    #     )
...
class ApifyClientAsync(_BaseApifyClient):
    ...
    #         resource_id=key_value_store_id, **self._options()
    #     )
    ...
    #         webhook_dispatch_id (str): ID of the webhook dispatch to access
    #     """
    #     return WebhookDispatchClientAsync(
    #         resource_id=webhook_dispatch_id, **self._options()
    #     )
