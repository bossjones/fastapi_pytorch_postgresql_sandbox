...
from fastapi_pytorch_postgresql_sandbox.ml_client._errors import ApifyApiError
...
from fastapi_pytorch_postgresql_sandbox.ml_client.consts import ActorJobStatus
    ...
    def _wait_for_finish(self, wait_secs: Optional[int] = None) -> Optional[Dict]:
        ...
        while should_repeat:
            ...
            try:
                ...
                if ActorJobStatus(job["status"])._is_terminal or (
