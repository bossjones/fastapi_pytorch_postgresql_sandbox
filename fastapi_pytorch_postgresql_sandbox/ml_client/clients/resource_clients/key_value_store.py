...
#     def list_keys(
#         self, *, limit: Optional[int] = None, exclusive_start_key: Optional[str] = None
#     ) -> Dict:
...
#     def get_record(
#         self, key: str, *, as_bytes: bool = False, as_file: bool = False
#     ) -> Optional[Dict]:
...
#     def set_record(
#         self, key: str, value: Any, content_type: Optional[str] = None
#     ) -> None:
