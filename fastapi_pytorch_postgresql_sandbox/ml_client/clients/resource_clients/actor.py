...
# from fastapi_pytorch_postgresql_sandbox.ml_client.clients.resource_clients.actor_version import (
#     ActorVersionClient,
#     ActorVersionClientAsync,
# )
# from fastapi_pytorch_postgresql_sandbox.ml_client.clients.resource_clients.actor_version_collection import (
#     ActorVersionCollectionClient,
#     ActorVersionCollectionClientAsync,
# )
# from fastapi_pytorch_postgresql_sandbox.ml_client.clients.resource_clients.build_collection import (
#     BuildCollectionClient,
#     BuildCollectionClientAsync,
# )
# from fastapi_pytorch_postgresql_sandbox.ml_client.clients.resource_clients.run import (
#     RunClient,
#     RunClientAsync,
# )
# from fastapi_pytorch_postgresql_sandbox.ml_client.clients.resource_clients.run_collection import (
#     RunCollectionClient,
#     RunCollectionClientAsync,
# )
# from fastapi_pytorch_postgresql_sandbox.ml_client.clients.resource_clients.webhook_collection import (
...
class ActorClient(ResourceClient):
    ...
    def start(
        ...
        *,
        ...
        request_params = self._params(
            ...
            webhooks=_encode_webhook_list_to_base64(webhooks)
    ...
    #     origin: Optional[MetaOrigin] = None,
    # ) -> RunClient:
    ...
    #         **self._sub_resource_init_options(resource_id=version_number)
    #     )
...
class ActorClientAsync(ResourceClientAsync):
    ...
    async def update(
        ...
        *,
        ...
        return await self._update(
            _filter_out_none_values_recursively(actor_representation),
        )
    ...
    #     """Retrieve a client for the builds of this actor."""
    #     return BuildCollectionClientAsync(
    #         **self._sub_resource_init_options(resource_path="builds")
    #     )

    # def runs(self) -> RunCollectionClientAsync:
    #     """Retrieve a client for the runs of this actor."""
    #     return RunCollectionClientAsync(
    #         **self._sub_resource_init_options(resource_path="runs")
    #     )
    ...
    #     """
    #     return ActorVersionClientAsync(
    #         **self._sub_resource_init_options(resource_id=version_number)
    #     )
