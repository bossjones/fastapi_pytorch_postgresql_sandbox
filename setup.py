...
import fastapi_pytorch_postgresql_sandbox as package
...
def gh(name, version):
    ...
    if "GHE_ACCESS_TOKEN" in os.environ:
        ...
        proto = "git+ssh://git@"
    return "{proto}github.com/{name}.git@{version}" "#egg={package}-{version}".format(
        **locals()
    )
...
if __name__ == "__main__":  # noqa: C901
    ...
    # Your package name
    PKG_NAME = "fastapi_pytorch_postgresql_sandbox"

    # Your GitHub user name
    try:
        GITHUB_USERNAME = "bossjones"
    except:  # noqa: E722
    ...
    setup(
        ...
        # entry_points="""
        # [console_scripts]
        # fastapi_pytorch_postgresql_sandbox=fastapi_pytorch_postgresql_sandbox.cli:run
        # """,
    )
